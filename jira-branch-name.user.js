...
var button = `<button class="aui-button" id="get-branch-name">
                  <span class="icon aui-icon aui-icon-small aui-iconfont-devtools-branch"></span>
              </button>`;
var summaryEl = document.querySelector('#summary-val');
summaryEl.insertAdjacentHTML('afterend', button);
